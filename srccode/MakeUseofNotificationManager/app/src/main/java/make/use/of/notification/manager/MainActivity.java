package make.use.of.notification.manager;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void simpleNotification() {
        Person jd = new Person.Builder().setName("Vinod Kumar") .setImportant(true) .build();
        new NotificationCompat.MessagingStyle(jd)
                .addMessage("Check your mail", new Date().getTime(), jd) .setBuilder(builder);
    ...
    private void notificationWithIcon() {
        ...
        new NotificationCompat.MessagingStyle(anupam)
                .addMessage("Check your calender!", new Date().getTime(), anupam)
                .setBuilder(builder);
    ...
    private void notificationWithImage() {
        Person bot = new Person.Builder()
                ...
                .setBot(true) .build();
        Uri uri = Uri.parse("android.resource://com.journaldev.androidpnotifications/drawable/"+R.drawable.ic_launcher_foreground);
        NotificationCompat.MessagingStyle.Message message = new
                NotificationCompat.MessagingStyle.Message("Check your calender!", new Date().getTime(), bot);
    ...
    private void notificationSemantic()
    {
        ...
        NotificationCompat.Action replyAction =
                new NotificationCompat.Action.Builder(
                        R.drawable.ic_launcher_foreground, "MARK READ", pendingIntent)
